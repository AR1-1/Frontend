                            ...
                            <div className="panel-body">
                                <p>
                                    {dataSummary && dataSummary.categories && dataSummary.categories.totalCategories > 0
                                        ? dataSummary.categories.totalCategories + " categor" + (dataSummary.categories.totalCategories > 1 ? "ies" : "y") + " registered"
                                        : "No categories registered"
                                    }
                                </p>
                                <p>
                                    {dataSummary && dataSummary.articles && dataSummary.articles.totalArticles > 0
                                        ? dataSummary.articles.totalArticles + " item" + (dataSummary.articles.totalArticles > 1 ? "s" : "") + " registered"
                                        : "No items registered"
                                    }
                                </p>
                                <p>
                            ...
                            <div className="panel-body">
                                <p>
                                    {dataSummary && dataSummary.providers && dataSummary.providers.totalProviders > 0
                                        ? dataSummary.providers.totalProviders + " supplier" + (dataSummary.providers.totalProviders > 1 ? "s" : "") + " registered"
